package com.sbi.expo.bo.base.auth.jwt;

import com.sbi.expo.bo.base.auth.SkipPathRequestMatcher;
...
import com.sbi.expo.commons.utils.StringHelper;
...
public class JwtAuthenticationProcessingFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(
        ...
        if (this.isSwaggerRequest(request)) {
            JwtParser jwtParser =
                    new JwtParser(tokenPayload, this.jwtSettings.getTokenSigningKey());
            UserDetails userDetails =
                    new User(jwtParser.getSubject(), StringHelper.EMPTY, Collections.emptyList());
    ...
    protected boolean isSwaggerRequest(HttpServletRequest request) {
        String header = request.getHeader(HttpHeaders.REFERER);
        return StringUtils.contains(header, CommonConstant.SWAGGER_PATH);
    }
