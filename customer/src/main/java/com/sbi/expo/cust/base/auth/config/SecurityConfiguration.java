...
import com.sbi.expo.cust.base.auth.UnauthorizedEntryPoint;
import com.sbi.expo.cust.base.auth.jwt.JwtAuthenticationProcessingFilter;
import com.sbi.expo.cust.base.auth.jwt.JwtSettings;
import com.sbi.expo.cust.base.auth.login.LoginProcessingFilter;
...
public class SecurityConfiguration {
    ...
    private JwtAuthenticationProcessingFilter jwtAuthenticationProcessingFilter() {
        return new JwtAuthenticationProcessingFilter(
                jwtAuthenticationFailureHandler, jwtSettings, userDetailsService);
    }
}
