 ...
 */
@Slf4j
public class BitsStringUtil extends org.apache.commons.lang3.StringUtils {

    /**
     * camel hump case naming tool
     *
        ...
        for (int i = 0; i < s.length(); i++) {
            ...
            if ((i > 0) && Character.isUpperCase(c)) {
                if (!upperCase || !nextUpperCase) {
                    sb.append(CommonConstant.SEPARATOR);
                }
                upperCase = true;
            } else {
                upperCase = false;
