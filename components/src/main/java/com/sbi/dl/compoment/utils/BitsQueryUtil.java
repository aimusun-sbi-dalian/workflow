...
import com.sbi.dl.compoment.annotation.Query;
...
public class BitsQueryUtil {
    ...
    public static <R, Q> Predicate getPredicate(Root<R> root, Q query, CriteriaBuilder cb) {
        ...
        try {
            ...
            for (Field field : fields) {
                ...
                // set access previllage , make sure private fileds are accessable
    ...
    private static <T, R> Expression<T> getExpression(
            String attributeName, Join join, Root<R> root) {
        if (ObjectUtils.isNotEmpty(join)) {
